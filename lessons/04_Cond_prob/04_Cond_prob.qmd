...
-   While the probability of hypertension in a randomly chosen adult is 0.29, the **conditional probability** of hypertension in a person known to be 60 or older is 0.649

 

::: orange-ttl
How can we use probabilities to show this?
:::
...
- So far we have intuitively thought of conditional probability: 
...
1. Define the events in the problem
