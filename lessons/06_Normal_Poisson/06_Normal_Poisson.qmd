...
:::
::: ex-cont
Suppose the distribution of diastolic blood
...
:::
::: ex-cont
About 25% of people that test positive for Covid-19 are
...
![](../img_slides/binom_n100_p25_crop.png){width="5in"}
...
- The Poisson distribution is often used to model **count data (# of successes)**, especially for **rare
    events**
...
-   Also used to approximate binomial distribution when $n$ is large and $p$ is small
