...
## Important definitions in words
...
- **Power** (or sensitivity) ($1 - \beta$): Probability of rejecting the null hypothesis given that the null is true
- **Specificity** ($1-\alpha$): Probability of failing to reject the null hypothesis given that the null is false
...
* __Power vs. Type II error__
    ...
    * Thus as $\beta$ (which is P(Type II error)) decreases, the power increases
