...
2. Calculate the probability of disjoint (mutually exclusive) events

3. Calculate Probabilities for independent events and their joint outcomes

4. Use sample space and event complements to calculate probabilities.
...
1.  Suppose you roll a fair 6-sided die.
    ...
    a.  What is the probability that you roll a 4?

    b.  What is the probability that you roll an even number?

    c.  What is the probability that you did not roll a 3?

2.  Suppose you roll **two** fair 6-sided dice.

    a.  What is the probability that you roll a 2 with the first die and
        a 5 with the second die?
:::
:::
:::
:::
...
::: def-cont
How likely something will happen. On a more technical note, the
...
-   We can think of flipping a coin. There are two possible outcomes
    (heads or tails). The probability of getting heads is 0.5. If we
    flip the coin 10 times, it is not certain that we will get 5 heads.
    However, if we flip it infinite times, we will get heads 50% of the
    flips. [Fun seeing theory
...
## Disjoint / mutually exclusion events
...
Maybe venn diagram or some other TB example??
